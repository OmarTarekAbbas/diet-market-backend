...
class Coupon extends JsonResourceManager
{
    /**
     ...
     * @const array
     */
    const DATA = ['id', 'code', 'type', 'value', 'totalUses', 'maxUsage', 'minOrderValue', 'published', 'startsAt', 'endsAt','typeCoupon'];
     ...
     * @const array
     */
    const WHEN_AVAILABLE = ['totalUses', 'maxUsage', 'minOrderValue', 'couponDiscount','typeCoupon'];
