...
namespace App\Modules\Banks\Resources;

use HZ\Illuminate\Mongez\Managers\Resources\JsonResourceManager;

class BankTransfer extends JsonResourceManager
{
    /**
     ...
     * @const array
     */
    const DATA = ['id', 'accountName', 'accountNumber', 'notes', 'amount', 'status', 'orderId', 'bankTransferFrom'];
