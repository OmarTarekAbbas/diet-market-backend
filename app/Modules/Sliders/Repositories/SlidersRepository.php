...
use App\Modules\Sliders\Models\Slider as Model;
use App\Modules\Sliders\Filters\Slider as Filter;
use App\Modules\Sliders\Resources\Slider as Resource;

use HZ\Illuminate\Mongez\Contracts\Repositories\RepositoryInterface;
use HZ\Illuminate\Mongez\Managers\Database\MongoDB\RepositoryManager;

class SlidersRepository extends RepositoryManager implements RepositoryInterface
{
    /**
     * Repository Name
     *
    ...
    {
        Model::where('banners.id', $banner->id)->update([
            'banners.$' => $banner->sharedInfo(),
        ]);
    }

    public function onSave($model, $request, $oldModel = null)
    {
        $this->modulesRepository->updateSlider($model);
    }
}
