...
*/
Route::group([
    'namespace' => 'Modules\Newsletters\Controllers\Admin',
    'middleware' => ['authorized'], // this middleware is used to check if user/admin is logged in
], function () {
    // Sub API CRUD routes
    Route::apiResource('/newsletter/subscriptions', 'SubscriptionsController');
    // Main API CRUD routes
    Route::apiResource('/newsletter', 'NewslettersController');
});
