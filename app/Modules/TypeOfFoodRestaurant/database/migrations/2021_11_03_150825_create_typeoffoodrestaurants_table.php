...
class CreateTypeoffoodrestaurantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('typeoffoodrestaurants', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('typeoffoodrestaurants');
    }
}
