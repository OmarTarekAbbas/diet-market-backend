...
class CreateNutritionspecialistmangersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('nutritionspecialistmangers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('nutritionspecialistmangers');
    }
}
