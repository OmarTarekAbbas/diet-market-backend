...
/*
|--------------------------------------------------------------------------
| NutritionSpecialistMangers Admin Routes
|--------------------------------------------------------------------------
|
...
*/
Route::group([
    'namespace' => 'Modules\NutritionSpecialistMangers\Controllers\Admin',
    'middleware' => ['authorized'], // this middleware is used to check if user/admin is logged in
], function () {
    // Sub API CRUD routes
    // Main API CRUD routes
    Route::apiResource('/nutritionspecialistmangers', 'NutritionSpecialistMangersController');
});
