...
*/
Route::group([
    'namespace' => 'Modules\ClubBookings\Controllers\Admin',
    'middleware' => ['authorized'], // this middleware is used to check if user/admin is logged in
], function () {
    // Sub API CRUD routes
    // Main API CRUD routes
    Route::patch('/clubbookings/{clubBookingId}/{status}', 'ClubBookingsController@changeStatus')->name('clubBookings.changeStatus');
    Route::apiResource('/clubbookings', 'ClubBookingsController');
});
