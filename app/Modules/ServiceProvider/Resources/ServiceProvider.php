...
namespace App\Modules\ServiceProvider\Resources;

use App\Modules\Cities\Resources\City;
use App\Modules\Countries\Resources\Country;
use HZ\Illuminate\Mongez\Managers\Resources\JsonResourceManager;

class ServiceProvider extends JsonResourceManager
{
    /**
     ...
     * @const array
     */
    const STRING_DATA = ['firstName', 'lastName', 'email', 'tradeName', 'address', 'phoneNumber', 'commercialNumber','type'];
