...
*/
Route::group([
    'namespace' => 'Modules\Complaints\Controllers\Admin',
    'middleware' => ['logged-in'], // this middleware is used to check if user/admin is logged in
], function () {
    // Sub API CRUD routes
    // Main API CRUD routes
    Route::apiResource('/complaints', 'ComplaintsController');
    Route::post('/complaints/{id}/replay', 'ComplaintsController@replay');
});
