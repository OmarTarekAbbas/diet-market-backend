...
use App\Modules\TypeContactUs\Resources\TypeContactU;
use HZ\Illuminate\Mongez\Managers\Resources\JsonResourceManager;

class ContactU extends JsonResourceManager
{
    /**
     ...
     * @const array
     */
    const STRING_DATA = ['name', 'email', 'phone', 'subject', 'message', 'department'];
