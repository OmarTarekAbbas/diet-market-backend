...
use App\Modules\Settings\Filters\Setting as Filter;
use App\Modules\Settings\Resources\Setting as Resource;
...
class SettingsRepository extends RepositoryManager implements RepositoryInterface
{
    ...
    protected function mapValue(array $setting, $settingModel)
    {
        ...
        switch ($setting['type']) {
            case 'file':
                ...
                return $this->uploadImage($setting['value']);
            case 'intArray':
    ...
    /**
     * A shorthand method to get the value of application commission
     *
     * @return float
     */
    public function getAppCommission(): float
    {
        return (float) $this->getSetting('general', 'appCommission');
    }

    /**
     * A shorthand method to get the value of banks
     *
     * @return array
     */
    public function getBanks(): array
    {
        return (array) $this->getSetting('general', 'banks');
    }

    /**
     * A shorthand method to get the value of maintenance mode
     *
     * @return bool
     */
    public function getMaintenanceMode(): bool
    {
        return (bool) $this->getSetting('general', 'maintenance');
    }

    /**
     * A shorthand method to get the value of maintenance DeliveryMen mode
     *
     * @return bool
     */
    public function getMaintenanceDeliveryMenMode(): bool
    {
        return (bool) $this->getSetting('deliveryMen', 'maintenanceDeliveryMen');
    }
