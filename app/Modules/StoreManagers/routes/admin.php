...
*/
Route::group([
    'namespace' => 'Modules\StoreManagers\Controllers\Admin',
    'middleware' => ['authorized'], // this middleware is used to check if user/admin is logged in
], function () {
    // Sub API CRUD routes
    // Main API CRUD routes
    Route::apiResource('/store-managers', 'StoreManagersController');
    Route::post('/store-managers', 'StoreManagersController@create');
});
