...
use App\Modules\Campaigns\Models\Campaign as Model;
use App\Modules\Campaigns\Filters\Campaign as Filter;
use App\Modules\Campaigns\Resources\Campaign as Resource;
...
class CampaignsRepository extends RepositoryManager implements RepositoryInterface
{
    /**
     * {@inheritDoc}
     */
    ...
    public function onCreate($model, $request)
    {
        ...
        // $notifications->sendTopic('newCampaign', [
        //     'title' => $model->title,
        //     'body' => $model->content,
        ...
        $customers = $this->customersRepository->getQuery()->get();
