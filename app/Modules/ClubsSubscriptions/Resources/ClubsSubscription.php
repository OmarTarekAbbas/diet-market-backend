...
namespace App\Modules\ClubsSubscriptions\Resources;

use HZ\Illuminate\Mongez\Managers\Resources\JsonResourceManager;

class ClubsSubscription extends JsonResourceManager
{
    /**
     ...
     * @const array
     */
    const OBJECT_DATA = ['subscription', 'payment', 'club', 'status'];
