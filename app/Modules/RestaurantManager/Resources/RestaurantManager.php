...
namespace App\Modules\RestaurantManager\Resources;

use App\Modules\Restaurants\Resources\Restaurant;
use HZ\Illuminate\Mongez\Managers\Resources\JsonResourceManager;

class RestaurantManager extends JsonResourceManager
{
    /**
     ...
     * @const array
     */
    const DATA = ['id', 'email', 'accessToken', 'verificationCode', 'totalNotifications', 'phoneNumber'];
