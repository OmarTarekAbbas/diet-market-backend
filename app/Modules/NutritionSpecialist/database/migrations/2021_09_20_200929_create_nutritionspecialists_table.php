...
class CreateNutritionspecialistsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('nutritionspecialists', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('nutritionspecialists');
    }
}
