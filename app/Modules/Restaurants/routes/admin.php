...
Route::group([
    'namespace' => 'Modules\Restaurants\Controllers\Admin',
    ...
    Route::apiResource('/listRestaurants/reviews', 'RestaurantsReviewsController');
    Route::apiResource('/reasonRestaurant', 'ReasonRestaurantController');
    Route::apiResource('/deliveryRestaurant', 'DeliveryRestaurantController');
});
