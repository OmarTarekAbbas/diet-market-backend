...
namespace App\Modules\HealthyData\Resources;

use App\Modules\DietTypes\Resources\DietType;
use HZ\Illuminate\Mongez\Managers\Resources\JsonResourceManager;

class HealthyDatum extends JsonResourceManager
{
    /**
     ...
     * @const array
     */
    const DATA = ['id', 'healthInfo', 'specialDiet', 'type', 'specialDietGrams', 'specialDietPercentage','customerDeviceId'];
