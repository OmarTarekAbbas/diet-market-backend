...
namespace App\Modules\Nationality\Resources;

use HZ\Illuminate\Mongez\Managers\Resources\JsonResourceManager;

class Nationality extends JsonResourceManager
{
    /**
    ...
    {
        if (app()->getLocale() == 'en') {
            // $this->set('country', $this->country_en);
            $this->set('nationality', $this->nationality_en);
        } else {
            // $this->set('country', $this->country_ar);
            $this->set('natianality', $this->natianality_ar);
        }
    }
}
