...
*/
Route::group([
    'namespace' => 'Modules\CustomerGroups\Controllers\Admin',
    'middleware' => ['authorized'], // this middleware is used to check if user/admin is logged in
], function () {
    // Sub API CRUD routes
    // Main API CRUD routes
    Route::apiResource('/customers-groups', 'CustomerGroupsController');
    Route::post('/customersGroups/export', 'CustomerGroupsController@customersGroupExport');
});
