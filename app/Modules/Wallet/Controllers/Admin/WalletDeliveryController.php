...
class WalletDeliveryController extends AdminApiController
{
    /**
     * Controller info
     *
    ...
    public function withdraw(Request $request)
    {
        ...
        if ($validator->passes()) {
            $withdraw = $this->repository->createAction((int) $request->delivery, $request->amount, $request->title, $request->reason, $request->notes, 'withdraw');
    ...
    public function deposit(Request $request)
    {
        ...
        if ($validator->passes()) {
            $deposit = $this->repository->createAction((int) $request->delivery, $request->amount, $request->title, $request->reason, $request->notes, 'deposit');
