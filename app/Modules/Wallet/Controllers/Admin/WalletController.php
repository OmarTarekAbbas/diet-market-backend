...
class WalletController extends AdminApiController
{
    ...
    public function withdraw(Request $request)
    {
        ...
        if ($validator->passes()) {
            $withdraw = $this->repository->createAction((int) $request->customer, $request->amount, $request->title, $request->reason, $request->notes, 'withdraw');
    ...
    public function deposit(Request $request)
    {
        ...
        if ($validator->passes()) {
            $deposit = $this->repository->createAction((int) $request->customer, $request->amount, $request->title, $request->reason, $request->notes, 'deposit');
