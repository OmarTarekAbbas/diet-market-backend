...
class Review extends JsonResourceManager
{
    /**
     ...
     * @const array
     */
    const DATA = ['id', 'customer', 'orderId', 'orderQuality', 'deliverySpeed', 'review', 'rate', 'status'];
    ...
    const WHEN_AVAILABLE = [
        'customer', 'orderId', 'orderQuality', 'deliverySpeed', 'review', 'rate', 'status',
    ];
