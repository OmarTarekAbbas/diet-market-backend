...
use App\Modules\Orders\Filters\OrderItem as Filter;
use App\Modules\Orders\Resources\OrderItem as Resource;

use HZ\Illuminate\Mongez\Contracts\Repositories\RepositoryInterface;
use HZ\Illuminate\Mongez\Managers\Database\MongoDB\RepositoryManager;

class OrderItemsRepository extends RepositoryManager implements RepositoryInterface
{
    /**
     * Repository Name
     *
     ...
     * @const array
     */
    const MULTI_DOCUMENTS_DATA = ['isCountSeen'];
