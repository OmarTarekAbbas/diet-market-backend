...
abstract class ApiTestCase extends TestCase
{
    ...
    protected function handleAuthorizationHeader(array &$headers)
    {
        ...
        $headers['Authorization'] = $this->isAuthenticated ? 'Bearer ' . env('BEARER_TOKEN_RESTAURANT_MANAGER_DASHBOARD') : 'key ' . env('API_KEY');
    }
    ...
    protected function prepareUri(string $uri): string
    {
        ...
        $uri .= $this->isAuthenticated ? 'Token=' . env('BEARER_TOKEN_RESTAURANT_MANAGER_DASHBOARD') : 'Key=' . env('API_KEY');
        // dd($uri);
        return $uri;
    }
