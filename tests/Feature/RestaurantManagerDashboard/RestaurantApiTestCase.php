...
abstract class RestaurantApiTestCase extends ApiTestCase
{
    /**
     ...
     * @var string
     */
    protected $apiPrefix = '/api/restaurantManager';
     ...
     * @return  void
     */
    protected function successData(array $data, array $responseRecordShape)
    {
     ...
     * @return  void
     */
    protected function successFoundRecord()
    {
        $response = $this->get($this->route . $this->unitTesting);
